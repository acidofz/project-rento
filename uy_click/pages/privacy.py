        ...
        rx.box(
            rx.container(
                rx.vstack(
                    ...
                    rx.text(
                        "Как мы обрабатываем данные в UY-CLICK. Детали зависят от вашей настройки Supabase "
                    ...
                    rx.text(
                        ...
                        "(через Supabase Auth), профиль, объявления (включая признак премиум-размещения "
                        "в ленте), сообщения в чате, избранное, технические логи хостинга. "
                        "Загрузка фото объявлений хранится в Supabase Storage.",
                        size="2",
